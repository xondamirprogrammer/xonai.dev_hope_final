      ...
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-4 lg:space-x-6 text-sm lg:text-base">
          {isSmartWebsitesPage ? (
            ...
            <>
              <a href="#why-this-matters" onClick={(e) => handleNavLinkClick(e, 'why-this-matters')} className="text-muted-foreground hover:text-foreground transition-colors">Why Agents</a>
              <a href="#whats-included" onClick={(e) => handleNavLinkClick(e, 'whats-included')} className="text-muted-foreground hover:text-foreground transition-colors">Included</a>
        ...
        <div className="md:hidden bg-background/95 backdrop-blur-md border-t border-border">
          <div className="container mx-auto px-4 py-4 space-y-4">
            {isSmartWebsitesPage ? (
              ...
              <>
                <a href="#why-this-matters" onClick={(e) => handleNavLinkClick(e, 'why-this-matters')} className="block text-muted-foreground hover:text-foreground transition-colors">Why Agents</a>
                <a href="#whats-included" onClick={(e) => handleNavLinkClick(e, 'whats-included')} className="block text-muted-foreground hover:text-foreground transition-colors">Included</a>
                ...
                <div className="space-y-6">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <a
                        href="mailto:xondamir@xonai.dev?subject=Project%20Inquiry&body=Hello,%20I'm%20interested%20in%20your%20AI%20services..."
                        className="text-foreground font-medium hover:text-primary transition-colors duration-300"
                      >
                        xondamir@xonai.dev
                      </a>
...
function AIAgentsContact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success('AI project request submitted!', {
        description: "We'll get back to you within 24 hours.",
      });
      setFormData({ name: '', email: '', need: '', message: '' });
    } catch (error) {
      console.error('Error submitting form:', error);
      toast.error('Failed to submit AI project request', {
        description: "Please check your connection and try again.",
      });
    } finally {
      setIsSubmitting(false);
...
function SmartWebsitesContact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.fullName || !formData.emailAddress || !formData.projectType || !formData.projectDescription) {
      toast.error('Please fill in all fields');
      return;
    }
